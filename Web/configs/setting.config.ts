...
export const settingCache = new NodeCache({ stdTTL: 300, checkperiod: 60 });
...
export const getAssetVersion = (): Promise<{ assetVersion?: string }> => getSetting<{ assetVersion?: string }>("assetVersion");
export const getCachedSetting = getSetting;
